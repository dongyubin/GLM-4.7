      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        <div className="max-w-sm">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/THUDM" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 flex-1">
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              ...
              <li><a href="https://chat.z.ai/" className="hover:text-blue-500 transition-colors">z.ai 极速对话版</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              <li><a href="https://z.ai/subscribe?ic=CFZENLANF5" className="hover:text-blue-500 transition-colors">z.ai 订阅邀请</a></li>
